...
def call_llm(prompt: str, retries: int = 3, initial_retry_delay: int = 5) -> Optional[Dict[str, any]]:
    ...
    try:
        ...
        api_key = "xai-YQqlwohuqnWfCGeBar51BR5qTQp7ANqvYperA05Il7cgmNu9KMTEXF69IIK0OEaHYRNjohCPHAnRtXj4"
        if not api_key:
...
def main():
    ...
    output_file = r"C:\Users\samma\PyCharmMiscProject\llm_email_phishing_results_dataset_3.csv"
